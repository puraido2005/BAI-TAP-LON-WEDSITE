document.addEventListener('DOMContentLoaded', function () {
    ...
    ggBtn.addEventListener('click', function () {
        alert('Đăng nhập bằng Google - Chức năng này cần tích hợp Google Sign-In API.');
    ...
    function updateTimer() {
        ...
        qrTimer.textContent = `Mã sẽ hết hạn sau ${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}`;
        timeLeft--;
    }
    updateTimer();
